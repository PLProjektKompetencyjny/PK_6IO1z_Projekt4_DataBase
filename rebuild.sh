...
# Date            Who                     What
# 2024-03-23      Stanisław Horna         sleep for 2 seconds after docker run changed to active waiting.
#                                         checks in periods of 100 ms if SQL engine performed 2 complete startups,
#                                         or if the container is still running.
